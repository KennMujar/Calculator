...
public class JFrameCalculator {
    ...
    public static void main(String[] args) {
        ...
        output.setBounds(-15, 60, 340, 100);
        ...
        /*
         * Font font = new Font(operators.getFont().getName(),
         * operators.getFont().getStyle(), 35);
    ...
    public void CryptoConverter() {
        ...
        panelUp.setMaximumSize(new Dimension(300, 300));
        panelUp.setPreferredSize(new Dimension(300, 300));
        panelUp.setAlignmentY(Component.CENTER_ALIGNMENT);
        panelUp.setBorder(BorderFactory.createTitledBorder("Options"));

        panelDown.setPreferredSize(new Dimension(300, 300));
        panelDown.setMaximumSize(new Dimension(300, 300));
        panelDown.setAlignmentY(Component.CENTER_ALIGNMENT);
        panelDown.setBorder(BorderFactory.createTitledBorder("Options"));
